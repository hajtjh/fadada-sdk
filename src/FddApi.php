...
use fadadaApi\data\ComplianceContractReport;
use fadadaApi\data\DocusignAcrosspage;
...
use fadadaApi\data\GeneralParam;
use fadadaApi\data\SmsParam;
...
class FddApi
{
	 ...
	 * 4.1合规化接口 注册账号
	 *
	 * @param FddAccount $param
	 * @param int        $timeOut
	 *
	 * @return array|mixed
	 */
	public static function registerAccount(FddAccount $param, int $timeOut = 6)
	{
		//注册接口
	 ...
	 */
	public static function getCompanyVerifyUrl(FddCertification $param, int $timeOut = 6):array
	{
		//获取企业实名认证地址
	 ...
	 * @return array 成功时返回，其他抛异常
	 */
	public static function getPersonVerifyUrl(FddCertification $param, int $timeOut = 6) : array
    {
		//获取个人实名认证地址
	 ...
	 * @return array 成功时返回，其他抛异常
	 */
	public static function ApplyCert(FddCertification $param, int $timeOut = 6) : array
    {
		//获取实名证书申请接口
	 ...
	 * @return array 成功时返回，其他抛异常
	 */
	public static function UploadSignature(FddSignature $param, int $timeOut = 6) : array
    {
		//合同模板传输接口 地址
	 ...
	 * @return array 成功时返回，其他抛异常
	 */
	public static function UploadSignatureContent(FddSignatureContent $param, int $timeOut = 6):array
	{
		//合同模板传输接口 地址
	 ...
	 * @return array 成功时返回，其他抛异常
	 */
	public static function Uploaddocs(FddTemplate $param, int $timeOut = 6):array
	{
		//合同文档传输接口 地址
	 ...
	 * @return array 成功时返回，其他抛异常
	 */
	public static function UploadTemplate(FddTemplate $param, int $timeOut = 6):array
	{
		//合同模板传输接口 地址
	 ...
	 * @return array 成功时返回，其他抛异常
	 */
	public static function GenerateContract(FddTemplate $param, int $timeOut = 6):array
	{
		//合同生成接口 地址
...
//                    throw new FddException("缺少必填参数-headers");
	 ...
	 * @return array 成功时返回，其他抛异常
	 */
	public static function ExtsignAuto(FddSignContract $param, int $timeOut = 6):array
	{
		// 文档签署接口（自动签） 地址
	 ...
	 */
	public static function Extsign(FddSignContract $param, int $timeOut = 6)
	{
		// 文档签署接口（手动签） 地址
...
//            return htmlspecialchars($url.$des->ArrayParamToStr($input));
	 ...
	 * @return array|string 成功时返回，其他抛异常
	 */
	public static function ExtsignValidation(FddSignContract $param, int $timeOut = 6)
	{
		// 文档签署接口（含有效期和次数限制） 地址
...
//            return htmlspecialchars($url.$des->ArrayParamToStr($input));
	 ...
	 * @return array 成功时返回，其他抛异常
	 */
	public static function QuerySignResult(FddQuerySignResult $param, int $timeOut = 6):array
	{
		//客户签署结果查询接口 地址
	 ...
	 * @return array|string 成功时返回，其他抛异常
	 */
	public static function ViewContract(FddContractManageMent $param, int $timeOut = 6)
	{
		//文档查看接口
...
//            return htmlspecialchars($url.$des->ArrayParamToStr($input));
	 ...
	 */
	public static function GetUrl(FddContractManageMent $param, int $timeOut = 6):array
	{
		//文档临时查看/下载地址接口（含有效期和次数）
	 ...
	 * @return array|string 成功时返回，其他抛异常
	 */
	public static function DownLoadContract(FddContractManageMent $param, int $timeOut = 6)
	{
		//文档下载接口 地址
...
//            return htmlspecialchars($url.$des->ArrayParamToStr($input));
	 ...
	 * @return array 成功时返回，其他抛异常
	 */
	public static function GetContractHash(FddContractManageMent $param, int $timeOut = 6):array
	{
		//查询合同hash值接口
	 ...
	 * @return array 成功时返回，其他抛异常
	 */
	public static function ContractFiling(FddContractManageMent $param, int $timeOut = 6):array
	{
		//合同归档接口
	 ...
	 * @return array 成功时返回，其他抛异常
	 */
	public static function ContractVerify(FddSignContract $param, int $timeOut = 6):array
	{
		//  文档验签接口 地址
	 ...
	 * @return array 成功时返回，其他抛异常
	 */
	public static function FindPersonCertInfo(FddCertification $param, int $timeOut = 6):array
	{
		//查询个人实名认证信息
	 ...
	 * @return array 成功时返回，其他抛异常
	 */
	public static function FindCompanyCertInfo(FddCertification $param, int $timeOut = 6):array
	{
		//查询企业实名认证信息
	 ...
	 * @return array|string 成功时返回，其他抛异常
	 */
	public static function getFile(FddCertification $param, int $timeOut = 6)
	{
		// 通过uuid下载文件
...
//             return $res;
	 ...
	 * @return array|string
	 */
	public static function BeforeAuthsign(FddAuthSign $param, int $timeOut = 6)
	{
		// 获取授权自动签页面接口
...
//            return htmlspecialchars($url.$des->ArrayParamToStr($input));
	 ...
	 * @return array|mixed
	 */
	public static function GetAuthStatus(FddAuthSign $param, int $timeOut = 6)
	{
		// 查询授权自动签状态接口
	 ...
	 * @return array|mixed
	 */
	public static function CancelExtsignAutoPage(FddAuthSign $param, int $timeOut = 6)
	{
		// 取消授权签协议接口
	 ...
	 * @return array|mixed
	 */
	public static function QuerySignstatus(GeneralParam $param, int $timeOut = 6)
	{
		// 客户签署状态查询接口
	 ...
	 * @return array|mixed
	 */
	public static function BatchDownloadContract(FddContractManageMent $param, int $timeOut = 6)
	{
		// 文档批量下载接口
	 ...
	 * @return array|mixed
	 */
	public static function ShortUrl(FddSignContract $param, int $timeOut = 6)
	{
		// 生成短链接口
	 ...
	 * @return array|mixed
	 */
	public static function PushShortUrlSms(SmsParam $param, int $timeOut = 6)
	{
		// 自定义短信发送短链接口
	 ...
	 * @return array|mixed
	 */
	public static function SmsText(SmsParam $param, int $timeOut = 6)
	{
		// 自定义短信发送接口
	 ...
	 * 电子文件签署线上出证专业版接口
	 *
	 * @param ComplianceContractReport $param
	 * @param int                      $timeOut
	 *
	 * @return array|mixed
	 */
	public static function ComplianceContractReport(ComplianceContractReport $param, int $timeOut = 6)
	{
		// 电子文件签署线上出证专业版接口
	 ...
	 * @return array|mixed
	 */
	public static function ViewTemplate(FddTemplate $param, int $timeOut = 6)
	{
		// 查看合同模板
...
//            return htmlspecialchars($url.$des->ArrayParamToStr($input));
	 ...
	 * @return array|mixed
	 */
	public static function DownloadTemplate(FddTemplate $param, int $timeOut = 6)
	{
		// 合同模板下载
	 ...
	 * @return array|mixed
	 */
	public static function TemplateDelete(FddTemplate $param, int $timeOut = 6)
	{
		// 合同模板删除
	 ...
	 * @return array|mixed
	 */
	public static function DownloadTemplateImgs(FddTemplate $param, int $timeOut = 6)
	{
		// 合同模板图片下载
	 ...
	 * @return array|mixed
	 */
	public static function GetPdftemplateKeys(FddTemplate $param, int $timeOut = 6)
	{
		// 获取 pdf 模版表单域 key 值接口
	 ...
	 * @return array|mixed
	 */
	public static function AddKeys(FddTemplate $param, int $timeOut = 6)
	{
		// 添加表单域到模板
	 ...
	 * @return array|mixed
	 */
	public static function UploadTemplateDocs(FddTemplate $param, int $timeOut = 6)
	{
		// 上传合同模板接口
	 ...
	 * @return array|string
	 */
	public static function GetDocStream(FddTemplate $param, int $timeOut = 6)
	{
		// 根据模板id跳转编辑页面
...
//            return htmlspecialchars($url.$des->ArrayParamToStr($input));
	 ...
	 * @return array|mixed
	 */
	public static function FillPage(FddTemplate $param, int $timeOut = 6)
	{
		// 跳转合同填充页面接口
...
//            return htmlspecialchars($url.$des->ArrayParamToStr($input));
	 ...
	 * @return array|mixed
	 */
	public static function PersonVerifySign(FddSignContract $param, int $timeOut = 6)
	{
		// 快捷签署接口（个人）
	 ...
	 * @return array|mixed
	 */
	public static function BatchQuickSign(FddSignContract $param, int $timeOut = 6)
	{
		// 批量快捷签署接口（个人）
	 ...
	 * 骑缝章自动签
	 *
	 * @param DocusignAcrosspage $param
	 * @param int                $timeOut
	 *
	 * @return array|mixed
	 */
	public static function DocusignAcrosspage(DocusignAcrosspage $param, int $timeOut = 6)
	{
		// 骑缝章自动签
	 ...
	 * @return array|mixed
	 */
	public static function GotoBatchSemiautoSignPage(FddSignContract $param, int $timeOut = 6)
	{
		// 文档批量签署接口(半自动模式)
...
//            return htmlspecialchars($url.$des->ArrayParamToStr($input));
	 ...
	 * @return array|mixed
	 */
	public static function ExtBatchSignAuto(FddSignContract $param, int $timeOut = 6)
	{
		// 文档批量签署接口（全自动模式）
	 ...
	 * @return array|mixed
	 */
	public static function Authorization(FddSignature $param, int $timeOut = 6)
	{
		// 企业授权接口
	 ...
	 * @return array|mixed
	 */
	public static function AuthorizeSignature(FddSignature $param, int $timeOut = 6)
	{
		// 企业印章单个授权接口
	 ...
	 * @return array|mixed
	 */
	public static function FindSignatureAuthList(FddSignature $param, int $timeOut = 6)
	{
		// 查询印章授权关系
	 ...
	 * @return array|mixed
	 */
	public static function QuerySignature(FddSignature $param, int $timeOut = 6)
	{
		// 查询签章接口
	 ...
	 * @return array|mixed
	 */
	public static function ReplaceSignature(FddSignature $param, int $timeOut = 6)
	{
		// 替换签章接口
	 ...
	 * @return array|mixed
	 */
	public static function RemoveSignature(FddSignature $param, int $timeOut = 6)
	{
		// 删除签章接口
	 ...
	 * @return array|mixed
	 */
	public static function DefaultSignature(FddSignature $param, int $timeOut = 6)
	{
		// 设置默认章接口
	 ...
	 * @return mixed
	 */
	public static function https_request($url, $data = "", string $type = "post", string $res = "json")
	{
		//1.初始化curl
		$curl = curl_init();
		// 设置 utf-8 编码
	 ...
	 * @return void
	 */
	public static function https_request_file($url, string $data = "", string $type = "post")
	{
		//1.初始化curl
		$curl = curl_init();
		//2.设置curl的参数
